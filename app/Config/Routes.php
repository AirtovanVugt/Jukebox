...
$routes->get('/setInSession/(:alphanum)', 'playlist::setInSession/$1');
$routes->get('/removeInSession/(:alphanum)', 'playlist::removeInSession/$1');
$routes->post('/createSessionPlaylist', 'playlist::createSessionPlaylist');
